...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public Object[] getImplementations() {
        Object[] res = { NetworkHandler.class, SubnetHandler.class, PortHandler.class, RouterHandler.class, FloatingIpHandler.class, SecurityGroupHandler.class, SecurityGroupRulesHandler.class, LoadBalancerPoolHandler.class, LoadBalancerPoolMemberHandler.class, VIPHandler.class };
        return res;
    }
    ...
    public void configureInstance(Component c, Object imp, String containerName) {
        ...
        if (imp.equals(LoadBalancerPoolHandler.class)) {
            c.setInterface(INeutronLoadBalancerPoolAware.class.getName(), null);
        }
        if (imp.equals(LoadBalancerPoolMemberHandler.class)) {
            c.setInterface(INeutronLoadBalancerPoolMemberAware.class.getName(), null);
        }
        if (imp.equals(VIPHandler.class)) {
            c.setInterface(INeutronLoadBalancerAware.class.getName(), null);
        }
